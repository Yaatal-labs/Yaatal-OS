...
class HarnessClientTest(unittest.TestCase):
    def test_invokes_argument_array_and_sends_only_edge_turn_request(self):
        ...
        client = HarnessClient(binary="edge-turn", run=runner)
    ...
    def test_rejects_boolean_confidence(self):
        client = HarnessClient(binary="edge-turn", run=RecordingRunner())
    ...
    def test_rejects_non_json_stdout(self):
        ...
        client = HarnessClient(binary="edge-turn", run=run)
